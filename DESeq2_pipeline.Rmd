...
rownames(sampleDistMatrix) <- paste(colnames(my_rld), ' (', my_rld$histologicalStage, ')', sep="")
...
### 4.2. Volcano plot of the results

```{r}
EnhancedVolcano(my_resLFC,
    lab = rownames(my_resLFC),
    x = 'log2FoldChange',
    y = 'padj',
    ylim = c(0, 25),
    xlim = c(-7.5, 5),
    title = "Volcano plot",
    subtitle = "Differential Gene Expression in Oocyte Development of Cod")
```
